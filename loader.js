...
meta.settings.setMultiple('settings', {
  title: 'Bugdex',
  browserTitle: 'Bugdex - 全球开发者的奇葩Bug社区',
  description: '全球程序员投稿、竞猜、评论奇葩Bug、爆笑报错、迷惑行为的开放社区。你不只是解决问题，更是在讲“Bug故事”！',
  keywords: 'Bugdex, Bug故事, 程序员, 报错, 竞猜, 爆笑, 奇葩, 开发者社区',
  'brand:logo:alt': 'Bugdex',
  // 'brand:logo': '你的LOGO图片URL' // 如有LOGO图片可自动设置
});
